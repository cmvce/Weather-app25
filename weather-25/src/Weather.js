   ...
   <div className="container">
    <header>
        <form className='formBox' onSubmit={submit}>
          <input type="text" placeholder="Enter a city..." className='searchBox w-50' onChange={updateCity}/>
      ...
      <main>
        <div className="current-weather text-warning">
          <div>
            <h1 className="current-city" >     {city}
              </h1>
            <p className="details">
              <span className="date-time text-warning"> Saturday 16:00 </span>, {weather.description} <br />
              Humidity: <strong>{weather.humidity}%</strong>, Wind: <strong>{weather.wind}km/h</strong>
            </p>
          </div>
          <div className="current-temperature">
            <span className="temperature-icon"> </span>
            <span className="current-temperature-value">{Math.round(weather.temperature)}</span>
